                ...
                <div class="row">
                    <div class="col-12 col-lg-12 col-xxl-12 d-flex" style="color: #344767;">
                        <div class="card flex-fill p-3">
                            <form role="form" action="<?= base_url('/sub-edit-satker'); ?>" method="post" class="pb-5">
                                <div class="col-8">
                                    ...
                                    <div class="row mb-2 ms-1" style="font-size:1em;">
                                        Nama Kasatker
                                        <input id="nama_kasatker" name="nama_kasatker" type="text" class="form-control form-control-sm mt-2" placeholder="" aria-label="Nama Kasatker" value="<?= $detail_satker['nama_kasatker']; ?>" required>
                                    </div>
                                    <div class="row mb-2 ms-1" style="font-size:1em;">
                                        Jenis Satker
