    ...
    <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <!-- Disini gue mau href-nya kalau ada data 'id_user', 'id_satker', dan 'id_soal' di tabel penilaian, maka hrefnya ke id_penilaian, jatohnya ke form edit. tapi kalau nggak ada, jatohnya ke form input. -->
                <?php $nomor = 1;
                foreach ($soal_satker as $s) :
                ?>
                    <li class="nav-item">
