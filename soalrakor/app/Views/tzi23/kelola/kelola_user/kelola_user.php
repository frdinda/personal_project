                            ...
                            <div class="tab-content card-body flex-fill p-3 table-responsive" id="myTabContent">
                                <div class="tab-content mt-4 ms-2 me-2" id="myTabContent">
                                    <div class="col-2 ps-0 ms-0">
                                        <a href="<?= base_url('/tambah-user-tzi23/'); ?>" class="btn btn-primary table text-lg">Tambah User</a>
                                    </div>
                                                ...
                                                <?php foreach ($data_user as $u) :  ?>
                                                    <tr>
                                                        ...
                                                        <td class="mb-0 text-sm ps-0 scope=" row">
                                                            <a href="<?= base_url('/edit-user-tzi23/' . $u['id_user']); ?>" class="btn btn-primary table text-sm">Edit</a>
                                                        </td>
                                                        <td class="mb-0 text-sm" scope="row">
                                                            <form action="<?= base_url('/hapus-user-tzi23/' . $u['id_user']); ?>" method="post" class="d-inline">
                                                                <?= csrf_field(); ?>
