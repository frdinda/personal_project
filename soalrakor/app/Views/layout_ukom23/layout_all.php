...
<body class="g-sidenav-show bg-gray-100">
    <div class="min-height-300 position-absolute w-100 top-0" style="background-image: url('../assets_argon/img/bg-profile.jpg'); background-position-y: 50%;"></div>
    <!-- SIDEBAR -->
    <div class="min-height-300 position-absolute w-100 top-0" style="background-image: url('../assets_argon/img/bg-profile.jpg'); background-position-y: 50%;"></div>
    <!-- SIDEBAR -->
    ...
    <script>
        ...
        $(".form-select-pilihan-periode").select2({
            theme: "bootstrap-5"
        });
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#table-peserta-periode').DataTable({
                "dom": '<"toolbar">frtip',
                "info": false,
                "order": [
                    [0, 'asc']
