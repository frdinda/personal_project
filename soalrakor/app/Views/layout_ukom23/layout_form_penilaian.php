...
<body class="g-sidenav-show bg-gray-100">
    ...
    <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="<?= base_url('/beranda-ukom23'); ?>" target="_blank">
                <div class="col ms-0 ps-0">
                    <img src=" ../assets_argon/img/logo_fix.ico" class="navbar-brand-img h-100 pe-0" style="vertical-align: middle;" alt="main_logo">
                    <span class="ms-1 mt-0 font-weight-bold ps-0" style="font-size:1.75vw; vertical-align: middle">UKOM SUMUT</span>
                </div>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <!-- Disini gue mau href-nya kalau ada data 'id_user', 'id_peserta', dan 'id_soal' di tabel penilaian, maka hrefnya ke id_penilaian, jatohnya ke form edit. tapi kalau nggak ada, jatohnya ke form input. -->
                <?php $nomor = 1;
                foreach ($soal_peserta as $s) :
                ?>
                    <li class="nav-item">
