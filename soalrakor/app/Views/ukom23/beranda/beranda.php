        ...
        <div class="col-lg-12 mb-lg-0 mb-4">
            <div class="card z-index-2 h-auto">
                <div class="card-header pb-0 pt-3 bg-transparent">
                    <b>
                        <h3 class="text-capitalize" style="color: #344767;">Dashboard Penilaian Periode <?= $periode_berjalan_sementara['nama_periode']; ?></h3>
                    </b>
                </div>
                <div class="row">
                    <div class="col-12 col-lg-12 col-xxl-12 d-flex" style="color: #344767;">
                        <div class="card flex-fill p-4">
                            <div class="row mb-5">
                                <div class="col-4">
                                    <form role="form" action="<?= base_url('/pilihan-periode-beranda'); ?>" method="post">
                                        <div class="row">
                                            <div class="col-10">
                                            ...
                                            <?php foreach ($daftar_peserta as $d) : ?>
                                                <tr>
                                                    ...
                                                    foreach ($pembagian_soal as $p) :
                                                        ...
                                                        if ($d['id_peserta'] == $p['id_peserta']) {
                                                            foreach ($nilai_dashboard as $n) :
                                                                if ($p['id_soal'] == $n['id_soal'] && $d['id_peserta'] == $n['id_peserta']) {
                                                    ...
                                                    <td class="mb-0 ms-0 ps-0 text-sm" scope="row">
                                                        <a href="<?= base_url('/detail-nilai-ukom23/' . $d['id_peserta'] . '-' . $periode_berjalan_sementara['id_periode']); ?>" class="btn btn-primary table text-sm">Detail</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
