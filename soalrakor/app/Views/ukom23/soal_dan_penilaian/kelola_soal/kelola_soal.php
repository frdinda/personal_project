                        ...
                        <div class="card flex-fill p-3">
                            <div class="tab-content card-body flex-fill p-3 table-responsive" id="myTabContent">
                                <div class="col-6 ps-0 ms-0">
                                    <a href="<?= base_url('/tambah-soal-ukom23/'); ?>" class="btn btn-primary me-2" style="font-size:1em;">Tambah Soal</a>
                                    <a href="<?= base_url('/mulai-random-soal-ukom23/'); ?>" class="btn btn-success me-2" style="font-size:1em;">Mulai Randomisasi Soal</a>
                                    <a href="<?= base_url('/reset-random-soal-ukom23/'); ?>" class="btn btn-danger" style="font-size:1em;">Reset Randomisasi Soal</a>
                                </div>
                                            ...
                                            <tbody>
                                                <?php foreach ($soal as $s) : ?>
                                                    <tr>
                                                        ...
                                                        <td class="mb-0 text-sm" scope="row"><?php if ($s['kategori'] == 'pilgan') {
                                                                                                    echo "a. " . $s['jawaban_1'] . '; b. ' . $s['jawaban_2'] . '; c. ' . $s['jawaban_3'] . '; d. ' . $s['jawaban_4'];
                                                                                                } else {
                                                                                                    echo $s['jawaban'];
                                                                                                } ?></td>
                                                        <td class="mb-0 text-sm" scope="row"><?= $s['kategori']; ?></td>
                                                        <td class="mb-0 text-sm" scope="row">
                                                            <a href="<?= base_url('/edit-soal-ukom23/' . $s['id_soal']); ?>" class="btn btn-primary table text-sm">Edit</a>
                                                        </td>
                                                        <td class="mb-0 text-sm" scope="row">
                                                            <form action="<?= base_url('/hapus-soal-ukom23/' . $s['id_soal']); ?>" method="post" class="d-inline">
                                                                <?= csrf_field(); ?>
