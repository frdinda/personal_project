        ...
        <div class="col-lg-12 mb-lg-0 mb-4">
            <div class="card z-index-2 h-auto">
                <div class="card-header pb-0 pt-3 bg-transparent">
                    <b>
                        <h3 class="text-capitalize" style="color: #344767;">Tambah User</h3>
                    </b>
                </div>
                <div class="row">
                    <div class="col-12 col-lg-12 col-xxl-12 d-flex" style="color: #344767;">
                        <div class="card flex-fill p-3">
                            <form role="form" action="<?= base_url('/sub-tambah-user-ukom23'); ?>" method="post" class="pb-5">
                                <div class="col-8">
                                    <div class="row mb-2 ms-1" style="font-size:1em;">
                                        NIP
                                        <input id="id_user" name="id_user" type="text" class="form-control form-control-sm mt-2" placeholder="" aria-label="ID User" required>
                                    </div>
                                    <div class="row mb-2 ms-1" style="font-size:1em;">
                                        Nama
                                        <input id="nama_user" name="nama_user" type="text" class="form-control form-control-sm mt-2" placeholder="" aria-label="Nama User" required>
                                    </div>
                                    <div class="row mb-2 ms-1" style="font-size:1em;">
                                        Jenis Akses
                                    ...
                                    <div class="row mb-3 ms-1" style="font-size:1em;">
                                        Jabatan
                                        <input id="jabatan_user" name="jabatan_user" type="text" class="form-control form-control-sm mt-2" placeholder="" aria-label="Jabatan user" required>
                                    </div>
                                    <div class="row mb-3 ms-1" style="font-size:1em;">
                                        Password
