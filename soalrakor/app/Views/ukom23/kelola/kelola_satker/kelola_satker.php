                            ...
                            <div class="tab-content card-body flex-fill p-3 table-responsive" id="myTabContent">
                                <div class="tab-content mt-4 ms-2 me-2" id="myTabContent">
                                    <div class="col-2 ps-0 ms-0">
                                        <a href="<?= base_url('/tambah-satker-ukom23/'); ?>" class="btn btn-primary table text-lg">Tambah Satker</a>
                                    </div>
                                    <div class="tab-pane fade show active" id="surat-all" role="tabpanel" aria-labelledby="surat-all-tab">
                                        <table class="table-hover" id="table-surat-all">
                                            ...
                                            <tbody>
                                                <?php foreach ($data_satker as $u) :  ?>
                                                    <tr>
                                                        <td class="mb-0 text-sm ps-0" scope="row"><?= $u['id_satker']; ?></td>
                                                        <td class="mb-0 text-sm ps-0" scope="row"><?= $u['nama_satker']; ?></td>
                                                        <td class="mb-0 text-sm ps-0" scope="row"><?= $u['jenis_satker']; ?></td>
                                                        <td class="mb-0 text-sm ps-0 scope=" row">
                                                            <a href="<?= base_url('/edit-satker-ukom23/' . $u['id_satker']); ?>" class="btn btn-primary table text-sm">Edit</a>
                                                        </td>
                                                        <td class="mb-0 text-sm" scope="row">
                                                            <form action="<?= base_url('/hapus-satker-ukom23/' . $u['id_satker']); ?>" method="post" class="d-inline">
                                                                <?= csrf_field(); ?>
