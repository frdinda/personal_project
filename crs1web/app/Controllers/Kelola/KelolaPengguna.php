...
class KelolaPengguna extends BaseController
{
    ...
    public function index()
    {
        ...
        if (isset($this->session->akses)) {
            $pengguna_layanan = $this->penggunaLayananModel->get_pengguna_layanan();
            $entry_pengguna_layanan = $this->entryPenggunaLayananModel->get_entry_pengguna_layanan();
            $jenis_layanan = $this->jenisLayananModel->get_jenis_layanan();
            $data = [
                'pengguna_layanan' => $pengguna_layanan,
                'nama_page' => 'Kelola Pengguna Layanan',
                'nama_user' => $this->session->nama_unit_kerja,
                'jenis_layanan' => $jenis_layanan,
                'entry_pengguna_layanan' => $entry_pengguna_layanan,
                'jenis_akses' => $this->session->akses,
                'user_id' => $this->session->user_id
            ];
            return view('kelola/kelola_pengguna_layanan/kelola_pengguna_layanan', $data);
        } else {
            echo "<script>
    ...
    public function TambahPengguna()
    {
        if (isset($this->session->akses)) {
            ...
            $data = [
                'jenis_layanan' => $jenis_layanan,
                'nama_page' => 'Tambah Pengguna Layanan',
                'nama_user' => $this->session->nama_unit_kerja,
                'data_user' => $data_user,
                'jenis_akses' => $this->session->akses,
                'user_id' => $this->session->user_id
            ];
            return view('kelola/kelola_pengguna_layanan/tambah_pengguna_layanan', $data);
        } else {
            echo "<script>
            alert('Anda Tidak Memiliki Akses, Silahkan Login');
            window.location.href='/';
    ...
    public function SaveTambahPengguna()
    {
        ...
        if (isset($detail_pengguna)) {
            ...
            window.location.href='/tambah-pengguna-layanan';
            </script>";
        } else {
            $jenis_tambah = $this->request->getVar('jenis_tambah');
    ...
    // DETAIL PENGGUNA
    public function DetailPengguna($no_telp_pengguna)
    {
        if (isset($this->session->akses)) {
            $detail_entry_pengguna = $this->entryPenggunaLayananModel->get_detail_entry_per_pengguna($no_telp_pengguna);
            // dd($detail_entry_pengguna);
            $detail_pengguna = $this->penggunaLayananModel->get_detail_pengguna_layanan($no_telp_pengguna);
            $jenis_layanan = $this->jenisLayananModel->get_jenis_layanan();
            $data = [
                ...
                'jenis_layanan' => $jenis_layanan,
                'nama_page' => 'Detail Pengguna Layanan',
                'nama_user' => $this->session->nama_unit_kerja,
                'jenis_akses' => $this->session->akses,
                'user_id' => $this->session->user_id
            ];
            return view('kelola/kelola_pengguna_layanan/detail_pengguna_layanan', $data);
        } else {
            echo "<script>
            alert('Anda Tidak Memiliki Akses, Silahkan Login');
            window.location.href='/';
    ...
    // EDIT PENGGUNA
    public function EditPengguna($no_telp_pengguna)
    {
        if (isset($this->session->akses)) {
            $detail_pengguna = $this->penggunaLayananModel->get_detail_pengguna_layanan($no_telp_pengguna);
            $jenis_layanan = $this->jenisLayananModel->get_jenis_layanan();
            ...
            $data = [
                'jenis_layanan' => $jenis_layanan,
                'nama_page' => 'Edit Pengguna Layanan',
                'nama_user' => $this->session->nama_unit_kerja,
                'data_user' => $data_user,
                'detail_pengguna' => $detail_pengguna,
                'jenis_akses' => $this->session->akses,
            ...
            return view('kelola/kelola_pengguna_layanan/edit_pengguna_layanan', $data);
        } else {
            echo "<script>
            alert('Anda Tidak Memiliki Akses, Silahkan Login');
            window.location.href='/';
    ...
    public function SaveEditPengguna()
    {
    ...
    // HAPUS PENGGUNA
    public function HapusPengguna($no_telp_pengguna)
    {
        $this->penggunaLayananModel->delete($no_telp_pengguna);
        echo "<script>
