...
<div class="row">
    <div class="col-lg-12 col-md-12 mt-0 mb-4">
        <div class="card">
            ...
            <div class="card-body">
                <div class="col-12 pb-3 tambah-entry-pengguna-umum" id="tambah-entry-pengguna-umum">
                    <form action="<?= base_url('/sub-tambah-entry-pengguna-umum'); ?>" method="post" class="tambah_pengguna pb-5" id="entry">
                        <?= csrf_field(); ?>
                        <div class="col-11 mb-3">
                            ...
                            <div class="input-group input-group-outline ms-1">
                                ...
                                <input type="text" id="" name="" class="form-control form-control-md fs-6" placeholder="" aria-label="Tanggal Entry" value="<?php echo 'Tanggal Entry: ' . date('d M, Y H:i:s'); ?>" style="color:#000000;" disabled>
                            </div>
                        </div>
                        <!-- masukkan nama emailnya, kalau ada emailnya muncul datanya tapi kalau nggak, gamuncul -->
                        <div class="col-11 mb-3">
                            <label class="form-label text-rose" for="no_telp_pengguna">
                                No Telp Pengguna (Whatsapp)
                            </label>
                            <div class="input-group input-group-outline ms-1 no_telp_pengguna_div">
                                <input type="number" id="no_telp_pengguna" name="no_telp_pengguna" class="form-control form-control-md fs-6 no_telp_pengguna" placeholder="" aria-label="No Telp Pengguna (Whatsapp)" style="color:#000000;" value="" required>
                            </div>
                        </div>
                        <div class="col-11 mb-3">
                            ...
                            <div class="input-group input-group-outline ms-1">
                                <input type="text" id="email_pengguna" name="email_pengguna" class="form-control form-control-md fs-6 email_pengguna" placeholder="" aria-label="Email Pengguna" style="color:#000000;" required>
                            </div>
                        </div>
                        <div class="col-11 mb-3">
                        ...
                        <div class="col-11 mb-3">
                            ...
                            <div class="input-group input-group-outline ms-1">
                                <select class="form-control form-select form-select-unit-kerja mt-0 fs-6" name="user_id" id="user_id" style="color:#000000;" required>
                        ...
                        <div class="col-11 mb-3">
                            ...
                            <div class="input-group input-group-outline ms-1">
                                <select class="form-control form-select form-select-unit-kerja mt-0 fs-6" name="jenis_layanan" id="jenis_layanan" style="color:#000000;" required>
                                    <option value="" selected disabled></option>
