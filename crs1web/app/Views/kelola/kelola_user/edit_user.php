        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="col-12 pb-3">
                    <form action="<?= base_url('/sub-edit-user'); ?>" method="post" class="edit_user pb-5" id="Edit">
                        ...
                        <div class="col-11 mb-3">
                            ...
                            <div class="input-group input-group-outline is-filled ms-1">
                                <select class="form-control form-select form-select-pengguna-layanan mt-0" name="jenis_akses" id="jenis_akses" style="color:#000000;" required>
                                    ...
                                    <?php } else if ($detail_user['jenis_akses'] == 'Duta Layanan') { ?>
                                        <option value="Admin">Admin</option>
                                        <option value="Duta Layanan" selected>Duta Layanan</option>
                                        <option value="Unit Kerja">Unit Kerja</option>
                                        <option value="Pegawai">Pegawai</option>
                                    <?php } else if ($detail_user['jenis_akses'] == 'Unit Kerja') { ?>
                                        <option value="Admin">Admin</option>
                                        <option value="Duta Layanan">Duta Layanan</option>
                                        <option value="Unit Kerja" selected>Unit Kerja</option>
                                        <option value="Pegawai">Pegawai</option>
                                    <?php } else if ($detail_user['jenis_akses'] == 'Pegawai') { ?>
                                        <option value="Admin">Admin</option>
                                        <option value="Duta Layanan">Duta Layanan</option>
                                        <option value="Unit Kerja">Unit Kerja</option>
